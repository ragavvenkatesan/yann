...
class visualizer(module):
    ...
    def __init__( self, visualizer_init_args, verbose = 1 ):
        ...
        """ Needs to be done after batch_size is setup. 
...
class datastream(module):
    ...
    def set_data (self, type = 'train', batch = 0, verbose = 2):
        ...
        if data_x.shape[0] < self.cache_size:
            ...
            data_size_needed = (self.cache_size - data_x.shape[0], self.height * 
        ...
        elif data_x.shape[0] > self.cache_size:
            # don't know if this case will ever be used.
            data_x = data_x[:self.cache_size,]
